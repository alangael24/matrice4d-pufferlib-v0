...
# Native PPO + predictive visual auxiliary loss.
# Keeps rollout/action inference unchanged. During CUDA training only, a small
# head predicts t+1 retina moments from hidden state + executed action.

export BATCH_ID="${BATCH_ID:-v0_minimal_active_vision_16x16_race_predaux_seed44_500m}"
