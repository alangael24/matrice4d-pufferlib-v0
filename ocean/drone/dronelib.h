...
struct Log {
    ...
    float mean_abs_action_raw;
    float max_abs_action_raw;
    float raw_action_clip_frac;
    float mean_abs_action_clipped;
    float max_abs_action_clipped;
    float clipped_action_saturation_frac;
...
typedef struct {
    ...
    float raw_action_max_abs;
    float raw_action_saturation_count;
    float raw_action_clip_count;
    float clipped_action_abs_sum;
    float clipped_action_max_abs;
    float clipped_action_saturation_count;
