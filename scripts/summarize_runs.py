    ...
    with path.open("w", newline="", encoding="utf-8") as handle:
        ...
        for row in rows:
            ...
            writer.writerow({
                ...
                "hover_trim_rpm_mean": metrics.get("hover_trim_rpm_mean"),
                "hover_trim_rpm_max": metrics.get("hover_trim_rpm_max"),
                "hover_trim_rpm_frac_of_max": metrics.get("hover_trim_rpm_frac_of_max"),
                ...
                "k_thrust_mult_min": metrics.get("k_thrust_mult_min"),
                "k_thrust_mult_max": metrics.get("k_thrust_mult_max"),
